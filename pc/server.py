            ...
            try:
                ...
                몸["store"] = {
                    ...
                    "how": ("search?q= 로 찾는다. 좁히려면 q 에 kind:결정 · tag:이름 을 섞고, "
                            ...
                            "★ 한 번에 안 나오면 **갈래로 좁혀 한 번 더 물어라** — 위 kinds "
                            "중 그럴듯한 것을 골라 kind:결정 처럼 붙인다. 목록 밖에 있던 글이 "
                            "1~4등으로 올라온다 [잰 것: 오너 창고 2794장·얼린 물음 20개에서 "
                            "밖이던 3개가 3·4·4등으로 살아났다 — 가장 많은 갈래가 나머지를 밀어내던 것이다]. "
                            "틀린 갈래로 좁히면 0건이니, 아니면 다른 갈래로 한 번 더다. "
